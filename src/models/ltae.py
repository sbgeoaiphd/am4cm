...
class LTAE(nn.Module):
    def __init__(self, in_channels=128, n_head=16, d_k=8, mlp3=[256,128], mlp4=[128, 64, 32], n_classes=20, dropout=0.2, d_model=256,
                 T=1000, len_max_seq=24, return_att=False):
        """
